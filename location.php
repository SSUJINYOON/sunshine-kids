...
<script src="./js/sub-loaction.js"></script>
<h2 class="sub-title">찾아오시는길</h2>
<section class="location-section">
  <h3 class="hidden">지도</h3>
  <dl>
    <dt><i class="fa-solid fa-map"></i> 오시는길</dt>
    <dd>부산광역시 해운대구 좌동 113-111</dd>
    <dt><i class="fa-solid fa-phone-volume"></i> 전화번호</dt>
    <dd>070-7155-1979</dd>
    <dt><i class="fa-solid fa-fax"></i> 팩스번호</dt>
    <dd>02-2139-1142</dd>
  </dl>
  <section class="map">
    <h4 class="hidden">지도탭메뉴</h4>
    <nav>
      <button value="1" class="tab1 active">구글맵</button>
